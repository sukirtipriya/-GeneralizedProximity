computeRandomProximity <- function(targets_degree_distribution,genes_degree_distribution,graph_info,metric,iter=100){
  ...
  for (i in 1:iter){
    ...
    tmp <- computeProximity(random_node1,random_node2,graph_info,metric) 
